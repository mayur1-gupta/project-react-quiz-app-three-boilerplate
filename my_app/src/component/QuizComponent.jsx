    ...
    return (
      <div className='quiz'>
        ...
        <div className='buttons'>
            ...
            <button className='quit' onClick={this.Quit_Quiz}><Link to='/result' className='quit'>Quit</Link></button>
            <button className='finish'> <Link to='/result' className='finish'>Finish</Link></button>
          </div>
      </div>
    )
  }
